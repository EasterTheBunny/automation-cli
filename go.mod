module github.com/easterthebunny/automation-cli
...
require (
	...
	github.com/smartcontractkit/chainlink/v2 v2.6.0-beta0
...
replace (
	...
	github.com/cosmos/ibc-go/v7 => github.com/cosmos/ibc-go/v7 v7.3.0
